        ...
        <div class="main center column">
            <div class="block block1 row">
                ...
                <div class="right column">
                    ...
                    <ul class="column">
                        <li><i class="fa-solid fa-location-dot"></i> <p>104/140 Khuất Duy Tiến, phường Nhân Chính, Quận Thanh Xuân, Hà Nội.</p></li>
                        <li><i class="fa-solid fa-phone"></i> <p>02186 259 232</p></li>
                        <li><i class="fa-solid fa-envelope"></i> <p>admin@crcsolar.com.vn</p></li>
                    </ul>
                    <div class="hr"></div>
                    <h1>Lương Sơn, Hòa Bình</h1>
                    <span>Nhà máy</span>
                    <ul class="column">
                        <li><i class="fa-solid fa-location-dot"></i> <p>Lô 9, đường số 1, Khu công nghiệp Lương Sơn, xã Hòa Sơn, huyện Lương Sơn, tỉnh Hòa Bình.</p></li>
